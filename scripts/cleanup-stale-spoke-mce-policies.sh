...
export KUBECONFIG="${KUBECONFIG:-$PWD/build/hub-sno/install/auth/kubeconfig}"
...
rm -f build/hub-sno/site-a-hcp-policies/*mce*.yaml build/hub-sno/site-b-hcp-policies/*mce*.yaml 2>/dev/null || true
rm -f build/hub-sno/site-a-hcp-policies/*MCE*.yaml build/hub-sno/site-b-hcp-policies/*MCE*.yaml 2>/dev/null || true
